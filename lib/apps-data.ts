...
export const apps: App[] = [
  ...
  },
  {
    ...
    name: "שבעתיים",
    nameEn: "ShivaTime",
    description: "תיאום ביקורי ניחום — מצא שבעות קרובות ותאם ביקור",
    fullDescription:
      "כלי לתיאום ביקורי ניחום בשבעה. המשפחה היושבת שבעה מפרסמת שעות וכתובת, והמבקרים מסמנים מתי הם מתכננים להגיע. כך המשפחה יכולה לראות בזמן אמת כמה אנשים צפויים בכל שעה.",
    icon: "🕯️",

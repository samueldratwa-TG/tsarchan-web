        ...
        <section id="matched-stores" className="mb-10 scroll-mt-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
            <p className="text-sm text-gray-700 leading-relaxed">
              ...
              ב-25 בספטמבר, לעומת זאת, 52 מתוך 145 סניפים באמת העלו מחיר - וזה השינוי היחיד שהשיטה
              החדשה רושמת.
            </p>
          </div>
          ...
          <p className="text-gray-600 leading-relaxed mb-3">
            בבדיקה על כל הנתונים מאז 6 ביוני 2026, כ-44% מהתזוזות של החציון היו כאלה שבהן אף סניף
            משותף לא שינה מחיר, והן היוו כשליש מכל התנועה היומית של המדד. בשיטה החדשה התנועה היומית
          ...
          <div className="bg-gray-50 rounded-xl border border-gray-200 p-4 text-sm text-gray-600">
            ...
            <p className="leading-relaxed">
              ...
              Jevons על מדגם תואם), היא השיטה המקובלת לרמה הזאת של המדד במדריך הבינלאומי למדד המחירים
              לצרכן של ה-ILO וה-IMF. חשוב להבחין: המחיר שמוצג לכל רשת בטבלאות נשאר חציון הסניפים -
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="bg-purple-50 border border-purple-200 rounded-xl p-4">
              ...
              <p className="leading-relaxed">
                ...
                בספטמבר עבר מ-101.61 ל-101.36, והשינוי הגדול ביותר ביום בודד היה 0.44 נקודות (22

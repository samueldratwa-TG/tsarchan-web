...
export const metadata = {
  ...
  description: "איך מדד מחירי המזון עובד: מקורות הנתונים, מיפוי הברקודים, מדידת שינוי מחיר על אותם סניפים, סינון חריגים ומגבלות השיטה",
};
  ...
  return (
    <>
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-gray-800 mb-3 border-r-4 border-blue-500 pr-3">המחיר המוצג לכל רשת: למה חציון ולא ממוצע?</h2>
          <p className="text-gray-600 leading-relaxed mb-3">
          ...
          <ul className="space-y-2 text-gray-600 text-sm leading-relaxed list-disc pr-5">
            ...
            <li>
              ...
              ש&quot;ח - החציון לא זז בכלל. החציון מצוין לתיאור כמה המוצר עולה היום, אבל הוא לא מתאים
              למדידת השינוי מיום ליום - ראו הסעיף הבא.
            </li>
            <li>
          ...
          <p className="text-sm text-gray-500 leading-relaxed mt-3">
            ...
            שימו לב: <strong className="font-semibold text-gray-600">המדד עצמו לא הושפע</strong> מהשינוי הזה.
            עד 25 בספטמבר 2026 הוא חושב מחציון הסניפים, ומאז הוא מודד שינוי מחיר על אותם סניפים -
            ראו הסעיף הבא.
          </p>
        </section>

        {/* Section 2c: matched stores (2026-09-25) */}
        <section id="matched-stores" className="mb-10 scroll-mt-4">
          <h2 className="text-xl font-bold text-gray-800 mb-3 border-r-4 border-blue-500 pr-3">איך מודדים שינוי מחיר יומי? אותם סניפים, אתמול מול היום</h2>
          <p className="text-gray-600 leading-relaxed mb-3">
            כדי לדעת בכמה השתנה מחיר של מוצר ברשת מאתמול להיום, לא מספיק להשוות את החציון של היום
            לחציון של אתמול. הסיבה: הסניפים שמפרסמים משתנים מיום ליום. כשסניף אחד נכנס לקובץ או יוצא
            ממנו, החציון יכול לזוז <strong className="font-semibold text-gray-700">גם כשאף סניף לא שינה מחיר</strong>.
          </p>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
            <p className="text-sm text-gray-700 leading-relaxed">
              <strong className="font-semibold">דוגמה אמיתית מהנתונים שלנו.</strong> עגבניות בקרפור, כ-145
              סניפים, 19-25 בספטמבר 2026: החציון קפץ 9.90, 10.40, 10.90, 11.40, 10.90 ושוב 11.40 - חמש
              קפיצות בשישה ימים, ובארבע מהן שינה מחיר לכל היותר סניף אחד. המחירים 10.40 ו-11.40 לא
              קיימים באף סניף: זה הממוצע של שני הסניפים האמצעיים, שנוצר כשמספר הסניפים יוצא זוגי.
              בשיטה החדשה אותו שבוע נראה אחרת: אפס, אפס, ירידה של 0.08%, אפס, עלייה של 0.19% - ורק
              ב-25 בספטמבר, כש-52 מתוך 145 סניפים באמת העלו מחיר, נרשמה עלייה של 2.85%.
            </p>
          </div>
          <p className="font-medium text-gray-700 mb-2">איך זה עובד</p>
          <ul className="space-y-2 text-gray-600 text-sm leading-relaxed list-disc pr-5 mb-4">
            <li>
              <strong className="font-semibold text-gray-700">כל סניף מול עצמו.</strong> לכל סניף משווים את
              המחיר של היום למחיר הקודם של אותו סניף. סניף שדילג על יום מושווה למחיר האחרון שלו (עד 7
              ימים אחורה), כך שגם השינוי שלו נספר. סניף שנעדר יותר משבוע נחשב סניף חדש.
            </li>
            <li>
              <strong className="font-semibold text-gray-700">ממוצע גיאומטרי של השינויים.</strong> השינוי של
              הרשת הוא הממוצע הגיאומטרי של שינויי הסניפים, והרמה מתקדמת ממנו יום אחרי יום (שרשור).
            </li>
            <li>
              <strong className="font-semibold text-gray-700">כניסה ויציאה לא מזיזות את המדד.</strong> סניף
              חדש לא משפיע ביום שבו הוא מצטרף - הוא רק הופך לנקודת ההשוואה של מחר. סניף שיצא לא משפיע
              בכלל.
            </li>
            <li>
              <strong className="font-semibold text-gray-700">מינימום 5 סניפים להשוואה.</strong> אם יש פחות
              מ-5 סניפים שאפשר להשוות, הרשת לא רושמת שינוי באותו יום והערך הקודם נשמר. סניף בודד אף פעם
              לא קובע את המדד.
            </li>
            <li>
              <strong className="font-semibold text-gray-700">הגנה ממחירים שגויים.</strong> שינוי של יותר
              מפי 3 למעלה או למטה בסניף בודד נחשב מחיר שגוי ולא נספר.
            </li>
          </ul>
          <p className="text-gray-600 leading-relaxed mb-3">
            בבדיקה על כל הנתונים מאז 6 ביוני 2026, בכ-44% מהתזוזות של החציון, החציון של אותם סניפים
            לא זז בכלל - כל התזוזה נבעה מסניפים שנכנסו או יצאו - והן היוו כשליש מכל התנועה היומית של
            המדד. ב-38% מהתזוזות אף סניף לא שינה מחיר כלל. בשיטה החדשה התנועה היומית
            הכוללת ירדה בכמחצית, והמגמה לאורך זמן נשמרה. בפועל כמעט כל הסניפים חוזרים מיום ליום: בחציון,
            100% מהסניפים של היום פרסמו גם אתמול.
          </p>
          <div className="bg-gray-50 rounded-xl border border-gray-200 p-4 text-sm text-gray-600">
            <p className="font-medium text-gray-700 mb-1">גם זו לא שיטה שהמצאנו</p>
            <p className="leading-relaxed">
              השוואה של אותו פריט באותה נקודת מכירה לאורך זמן, וסיכום השינויים בממוצע גיאומטרי (שיטת
              Jevons על מדגם תואם), היא השיטה המועדפת לרמה הזאת של המדד ב
              <a href="https://www.ilo.org/sites/default/files/wcmsp5/groups/public/@dgreports/@stat/documents/publication/wcms_761444.pdf" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">
                מדריך הבינלאומי למדד המחירים לצרכן (CPI Manual 2020)
              </a>
              , שפרסמו ה-IMF, ה-ILO וארגונים בינלאומיים נוספים. חשוב להבחין: המחיר שמוצג לכל רשת בטבלאות נשאר חציון הסניפים -
              הוא עונה על השאלה &quot;כמה זה עולה היום&quot;, והמדד עונה על השאלה &quot;בכמה זה השתנה&quot;.
            </p>
          </div>
        </section>
            ...
            <li className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed mt-0.5">
                  ...
                  בסל, בכל הרשתות. השינוי היומי של רשת במוצר נמדד <strong>על אותם סניפים בלבד</strong> -
                  כל סניף מול המחיר הקודם שלו (ראו הסעיף הקודם). שני סינוני איכות חלים כאן: יום שבו רשת
                  פרסמה רק חלק קטן מהסניפים שלה מדולג (הערך האחרון הטוב מוחזק), ויום נכנס לחישוב רק אם
                  המוצר נצפה ב-<strong>5 סניפים לפחות</strong> - אותו רף בדיוק שחל על טבלת המוצרים - ויש
                  לפחות 5 סניפים שאפשר להשוות.
                </p>
              </div>
            </li>
            <li className="flex gap-3">
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            ...
            <li className="flex gap-2">
              <span className="text-red-400 font-bold">•</span>
              <span><strong>המחיר המוצג והמדד מחושבים אחרת:</strong> המחיר שמוצג לכל רשת בטבלאות הוא חציון הסניפים (רמת מחיר), והמדד מודד שינוי על אותם סניפים. לכן ייתכן שהמחיר המוצג של רשת לא ישתנה ביום שבו המדד רשם שינוי (למשל כשרק הסניפים היקרים מהאמצע העלו מחיר), או להפך - שהחציון יזוז בגלל סניף שנכנס או יצא, בלי שהמדד יזוז. שני המספרים נכונים, כל אחד לשאלה שלו.</span>
            </li>
            <li className="flex gap-2">
              <span className="text-red-400 font-bold">•</span>
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="bg-purple-50 border border-purple-200 rounded-xl p-4">
              ...
              <p className="leading-relaxed">
                ...
                לקובץ או יצא ממנו יכול היה להזיז את המדד בלי שום שינוי מחיר. מעכשיו כל סניף מושווה
                למחיר הקודם שלו, והשינויים מסוכמים בממוצע גיאומטרי (
                <a href="#matched-stores" className="text-purple-900 underline">הסבר מלא</a>). כל התקופה
                מ-6 ביוני 2026 חושבה מחדש; ההיסטוריה שלפני כן ומחירי הבסיס לא השתנו. כתוצאה, המדד ל-25
                בספטמבר עבר מ-101.61 ל-101.36, והתיקון הגדול ביותר לערך של יום בודד היה 0.44 נקודות (22
                בספטמבר) - <strong>זו הסרת רעש, לא ירידת מחירים</strong>. המחירים שמוצגים לכל רשת
                בטבלאות לא השתנו - הם עדיין חציון הסניפים.
              </p>
            </li>
            <li className="bg-purple-50 border border-purple-200 rounded-xl p-4">

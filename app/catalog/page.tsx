    ...
    <>
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <p className="text-xs text-gray-400 mt-4 leading-relaxed">
          הנתונים מבוססים על קובץ המחירים היומי של כל רשת.
          {catalog.counts.single > 0
            ? ` ${catalog.counts.single} מוצרים מופיעים ברשת אחת בלבד ולכן אין עבורם השוואה בין רשתות.`
            : " כל המוצרים בקטלוג נמכרים בשתי רשתות לפחות, כך שניתן להשוות את מחיריהם בין הרשתות."}
          {" "}שמות וכתובות הסניפים נכונים למועד העדכון האחרון של מאגר הסניפים ועשויים להתעדכן בפיגור.
        </p>
      </main>
      <Footer />
    </>

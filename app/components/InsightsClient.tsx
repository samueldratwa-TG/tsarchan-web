        ...
        <div className="space-y-5 text-sm">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              מספיק שסניף אחד נכנס לקובץ או יצא ממנו. בבדיקה על כל הנתונים מאז 6 ביוני, בכ-44%
              מהתזוזות של החציון, החציון של אותם סניפים לא זז כלל - כל התזוזה נבעה משינוי בהרכב
              הסניפים. מאז אנחנו מודדים שינוי מחיר רק על אותם סניפים, כל סניף
